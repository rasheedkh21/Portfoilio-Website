  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        <div>
        <h3>Rashee<span style={{color:"blue"}}>Dev</span></h3>
        </div>
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/abdurashid.bozorov.58"
            ...
            <li>
              <a
                href="https://www.instagram.com/rasheedkh_"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://twitter.com/iamrashiddev"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/bozorov-abdurashid-76b4a025a/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">All Rigths Reserved</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
